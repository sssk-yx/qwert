    ...
    <el-form label-width="100px">
        ...
        <el-form-item label="SPU图片">
            <!-- v-model:fileList->展示默认图片
                 ...
                 list-type:文件列表的类型
            -->
            <el-upload v-model:file-list="imgList as UploadUserFile[]" action="/api/admin/product/fileUpload"
            ...
            <el-table border style="margin:10px 0px" :data="saleAttr">
                ...
                <el-table-column label="销售属性值">
                    ...
                    <template #="{ row, $index }">
                        ...
                        <el-input @blur="toLook(row, $index, $event)" v-model="row.saleAttrValue"
                            v-if="row.flag == true" :ref="(vc) => inputRefs[$index] = vc" placeholder="请你输入属性值"
                            size="small" style="width:100px"></el-input>
                        <el-button @click="toEdit(row, $index)" v-else type="primary" size="small"
                            icon="Plus"></el-button>
                    </template>
                </el-table-column>
...
//表单元素失却焦点的事件回调
const toLook = (row: SaleAttr, $index, $event) => {
